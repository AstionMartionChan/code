...
${SPARK_HOME}/bin/spark-submit \
    --master yarn --deploy-mode cluster --name "realtime-wutiao-moneygain-statistics" --verbose --queue ${QUEUE} \
    --jars ${JAR_PATH}/RoaringBitmap-0.7.9.jar,${JAR_PATH}/spark-influx-sink-0.4.0-3-g0584cfd.jar,${JAR_PATH}/metrics-influxdb-1.2.3-SNAPSHOT.jar,${CONF_PATH}/moneygain.properties,${CONF_PATH}/metrics.properties \
    ...
    --properties-file ${CONF_PATH}/moneygain-statistics-spark.conf \
    --class "com.kingnetdc.job.MoneyGainStatistics" ${APP_JAR} \
    moneygain.properties
