...
${SPARK_HOME}/bin/spark-submit \
    --master yarn --deploy-mode cluster --name "realtime-wutiao-view-statistics" --verbose --queue ${QUEUE} \
    --jars ${JAR_PATH}/RoaringBitmap-0.7.9.jar,${JAR_PATH}/spark-influx-sink-0.4.0-3-g0584cfd.jar,${JAR_PATH}/metrics-influxdb-1.2.3-SNAPSHOT.jar,${CONF_PATH}/view.properties,${CONF_PATH}/metrics.properties \
    ...
    --properties-file ${CONF_PATH}/view-statistics-spark.conf \
    --class "com.kingnetdc.job.ViewStatistics" ${APP_JAR} \
    view.properties
