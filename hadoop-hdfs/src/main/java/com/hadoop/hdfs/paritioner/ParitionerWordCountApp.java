package com.hadoop.hdfs.paritioner;
 ...
 */
public class ParitionerWordCountApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jobName = ParitionerWordCountApp.class.getSimpleName();
        Job job = Job.getInstance(conf, jobName);
        job.setJarByClass(ParitionerWordCountApp.class);
