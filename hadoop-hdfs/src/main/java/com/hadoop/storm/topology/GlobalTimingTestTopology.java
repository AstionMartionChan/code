...
public class GlobalTimingTestTopology {
    ...
    public static void main(String[] args) {
        ...
        // 设置全局定时器
        config.put(Config.TOPOLOGY_TICK_TUPLE_FREQ_SECS, 0.001);
        StormTopology topology = topologyBuilder.createTopology();
        String topologyName = GlobalTimingTestTopology.class.getSimpleName();
