...
public class TermCountTopology {
    ...
    public static void main(String[] args) {
        ...
        topologyBuilder.setBolt("LocalCountBlot", new LocalCountBlot()).fieldsGrouping("SplitBlot", new Fields("str"));
        topologyBuilder.setBolt("GlobalCountBlot", new GlobalCountBlot()).globalGrouping("LocalCountBlot");

        Config config = new Config();
        StormTopology topology = topologyBuilder.createTopology();
        String topologyName = TermCountTopology.class.getSimpleName();
