...
<mapper namespace="${packagePath}.dao.${entityList[0].daoName}">
    ...
    <select id="selectById" parameterType="long"  resultType="${packagePath}.po.${entityList[0].entityName}">
        SELECT
        <#list entityList as entity>
        <#if entity_has_next>
    ...
    <select id="select" parameterType="${packagePath}.po.${entityList[0].entityName}"  resultType="${packagePath}.po.${entityList[0].entityName}">
        SELECT
        <#list entityList as entity>
        <#if entity_has_next>
            ${entity.columnName}${getSpace(entity.columnName?length, maxLength)}AS ${entity.fieldName},
    ...
    <insert id="insert" parameterType="${packagePath}.po.${entityList[0].entityName}" useGeneratedKeys="true" keyProperty="id">
    ...
    <update id="update" parameterType="${packagePath}.po.${entityList[0].entityName}">
