...
/**
 * org_config_element_type 转换类
 */
public class OrgConfigElementTypeEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return OrgConfigElementTypeEntity
     */
    public static OrgConfigElementTypeEntity toOrgConfigElementTypeEntity(OrgConfigElementTypeEntityVo vo, CommParamsVo commParamsVo) {
        OrgConfigElementTypeEntity entity = new OrgConfigElementTypeEntity();
        // ID
