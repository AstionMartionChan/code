...
/**
 * lbs_device_provider 转换类
 */
public class LbsDeviceProviderEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return LbsDeviceProviderEntity
     */
    public static LbsDeviceProviderEntity toLbsDeviceProviderEntity(LbsDeviceProviderEntityVo vo, CommParamsVo commParamsVo) {
        LbsDeviceProviderEntity entity = new LbsDeviceProviderEntity();
        // 自增Id
