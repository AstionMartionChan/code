...
/**
 * waybill_action_field 转换类
 */
public class WaybillActionFieldEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillActionFieldEntity
     */
    public static WaybillActionFieldEntity toWaybillActionFieldEntity(WaybillActionFieldEntityVo vo, CommParamsVo commParamsVo) {
        WaybillActionFieldEntity entity = new WaybillActionFieldEntity();
        // 自增ID
