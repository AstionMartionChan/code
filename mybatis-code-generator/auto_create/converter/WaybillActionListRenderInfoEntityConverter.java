...
/**
 * waybill_action_list_render_info 转换类
 */
public class WaybillActionListRenderInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillActionListRenderInfoEntity
     */
    public static WaybillActionListRenderInfoEntity toWaybillActionListRenderInfoEntity(WaybillActionListRenderInfoEntityVo vo, CommParamsVo commParamsVo) {
        WaybillActionListRenderInfoEntity entity = new WaybillActionListRenderInfoEntity();
        // 自增ID
