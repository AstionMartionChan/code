...
/**
 * org_config_accounting_charge_item_define 转换类
 */
public class OrgConfigAccountingChargeItemDefineEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return OrgConfigAccountingChargeItemDefineEntity
     */
    public static OrgConfigAccountingChargeItemDefineEntity toOrgConfigAccountingChargeItemDefineEntity(OrgConfigAccountingChargeItemDefineEntityVo vo, CommParamsVo commParamsVo) {
        OrgConfigAccountingChargeItemDefineEntity entity = new OrgConfigAccountingChargeItemDefineEntity();
        // 自增ID
