...
/**
 * waybill_downstream_goods_packing_list 转换类
 */
public class WaybillDownstreamGoodsPackingListEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillDownstreamGoodsPackingListEntity
     */
    public static WaybillDownstreamGoodsPackingListEntity toWaybillDownstreamGoodsPackingListEntity(WaybillDownstreamGoodsPackingListEntityVo vo, CommParamsVo commParamsVo) {
        WaybillDownstreamGoodsPackingListEntity entity = new WaybillDownstreamGoodsPackingListEntity();
        // 自增ID
        entity.setId(vo.getId());
        // 货品清单编码
        entity.setWaybillGoodsPackingListCode(vo.getWaybillGoodsPackingListCode());
        // 运单编码
        ...
        // 货物单价单位编码
        entity.setUnitPriceUnitCode(vo.getUnitPriceUnitCode());
        // 数量
        entity.setNumberQty(vo.getNumberQty());
        // 数量单位编码
        entity.setNumberQtyUnitCode(vo.getNumberQtyUnitCode());
        // 总重量
        entity.setTtlWeight(vo.getTtlWeight());
        // 总重量单位编码
        entity.setTtlWeightUnitCode(vo.getTtlWeightUnitCode());
        // 标准货量
        entity.setTotalWeight(vo.getTotalWeight());
        // 标准货量单位编码
        entity.setTotalWeightUnitCode(vo.getTotalWeightUnitCode());
        // 总体积
        entity.setTotalVolume(vo.getTotalVolume());
        // 总体积单位编码
        entity.setTotalVolumeUnitCode(vo.getTotalVolumeUnitCode());
        // 描述
