...
/**
 * waybill_action_search_render_info 转换类
 */
public class WaybillActionSearchRenderInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillActionSearchRenderInfoEntity
     */
    public static WaybillActionSearchRenderInfoEntity toWaybillActionSearchRenderInfoEntity(WaybillActionSearchRenderInfoEntityVo vo, CommParamsVo commParamsVo) {
        WaybillActionSearchRenderInfoEntity entity = new WaybillActionSearchRenderInfoEntity();
        // 自增ID
