...
/**
 * waybill_ticket_list_render_info 转换类
 */
public class WaybillTicketListRenderInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillTicketListRenderInfoEntity
     */
    public static WaybillTicketListRenderInfoEntity toWaybillTicketListRenderInfoEntity(WaybillTicketListRenderInfoEntityVo vo, CommParamsVo commParamsVo) {
        WaybillTicketListRenderInfoEntity entity = new WaybillTicketListRenderInfoEntity();
        // 自增ID
