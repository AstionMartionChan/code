...
/**
 * lbs_device_base_info 转换类
 */
public class LbsDeviceBaseInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return LbsDeviceBaseInfoEntity
     */
    public static LbsDeviceBaseInfoEntity toLbsDeviceBaseInfoEntity(LbsDeviceBaseInfoEntityVo vo, CommParamsVo commParamsVo) {
        LbsDeviceBaseInfoEntity entity = new LbsDeviceBaseInfoEntity();
        // 自增Id
