...
/**
 * lbs_polygon_base_info 转换类
 */
public class LbsPolygonBaseInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return LbsPolygonBaseInfoEntity
     */
    public static LbsPolygonBaseInfoEntity toLbsPolygonBaseInfoEntity(LbsPolygonBaseInfoEntityVo vo, CommParamsVo commParamsVo) {
        LbsPolygonBaseInfoEntity entity = new LbsPolygonBaseInfoEntity();
        // 自增id
