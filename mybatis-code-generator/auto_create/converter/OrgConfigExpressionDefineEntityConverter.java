...
/**
 * org_config_expression_define 转换类
 */
public class OrgConfigExpressionDefineEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return OrgConfigExpressionDefineEntity
     */
    public static OrgConfigExpressionDefineEntity toOrgConfigExpressionDefineEntity(OrgConfigExpressionDefineEntityVo vo, CommParamsVo commParamsVo) {
        OrgConfigExpressionDefineEntity entity = new OrgConfigExpressionDefineEntity();
        // 自增ID
