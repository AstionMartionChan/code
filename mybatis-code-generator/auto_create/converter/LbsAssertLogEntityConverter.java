 ...
 * lbs_assert_log 转换类
 */
public class LbsAssertLogEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return LbsAssertLogEntity
     */
    public static LbsAssertLogEntity toLbsAssertLogEntity(LbsAssertLogEntityVo vo, CommParamsVo commParamsVo) {
        LbsAssertLogEntity entity = new LbsAssertLogEntity();
        // 自增Id
