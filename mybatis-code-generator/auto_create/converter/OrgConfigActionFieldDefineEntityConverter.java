...
/**
 * org_config_action_field_define 转换类
 */
public class OrgConfigActionFieldDefineEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return OrgConfigActionFieldDefineEntity
     */
    public static OrgConfigActionFieldDefineEntity toOrgConfigActionFieldDefineEntity(OrgConfigActionFieldDefineEntityVo vo, CommParamsVo commParamsVo) {
        OrgConfigActionFieldDefineEntity entity = new OrgConfigActionFieldDefineEntity();
        // 自增ID
        ...
        // 对象名称
        entity.setTargetObjectName(vo.getTargetObjectName());
        // 要操作的字段
        entity.setTargetField(vo.getTargetField());
        // 要操作的字段名称
        entity.setTargetFieldName(vo.getTargetFieldName());
        // 数据源
