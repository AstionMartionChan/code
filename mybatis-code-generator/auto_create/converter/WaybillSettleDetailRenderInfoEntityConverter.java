...
/**
 * waybill_settle_detail_render_info 转换类
 */
public class WaybillSettleDetailRenderInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillSettleDetailRenderInfoEntity
     */
    public static WaybillSettleDetailRenderInfoEntity toWaybillSettleDetailRenderInfoEntity(WaybillSettleDetailRenderInfoEntityVo vo, CommParamsVo commParamsVo) {
        WaybillSettleDetailRenderInfoEntity entity = new WaybillSettleDetailRenderInfoEntity();
        // 自增ID
