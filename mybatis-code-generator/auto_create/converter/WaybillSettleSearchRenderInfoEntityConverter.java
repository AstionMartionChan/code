...
/**
 * waybill_settle_search_render_info 转换类
 */
public class WaybillSettleSearchRenderInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillSettleSearchRenderInfoEntity
     */
    public static WaybillSettleSearchRenderInfoEntity toWaybillSettleSearchRenderInfoEntity(WaybillSettleSearchRenderInfoEntityVo vo, CommParamsVo commParamsVo) {
        WaybillSettleSearchRenderInfoEntity entity = new WaybillSettleSearchRenderInfoEntity();
        // 自增ID
