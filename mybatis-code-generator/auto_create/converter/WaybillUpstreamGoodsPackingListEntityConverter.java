...
/**
 * waybill_upstream_goods_packing_list 转换类
 */
public class WaybillUpstreamGoodsPackingListEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillUpstreamGoodsPackingListEntity
     */
    public static WaybillUpstreamGoodsPackingListEntity toWaybillUpstreamGoodsPackingListEntity(WaybillUpstreamGoodsPackingListEntityVo vo, CommParamsVo commParamsVo) {
        WaybillUpstreamGoodsPackingListEntity entity = new WaybillUpstreamGoodsPackingListEntity();
        // 自增ID
