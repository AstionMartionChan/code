...
/**
 * waybill_downstream_base_info 转换类
 */
public class WaybillDownstreamBaseInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillDownstreamBaseInfoEntity
     */
    public static WaybillDownstreamBaseInfoEntity toWaybillDownstreamBaseInfoEntity(WaybillDownstreamBaseInfoEntityVo vo, CommParamsVo commParamsVo) {
        WaybillDownstreamBaseInfoEntity entity = new WaybillDownstreamBaseInfoEntity();
        // 自增ID
