...
/**
 * waybill_list_render_info 转换类
 */
public class WaybillListRenderInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillListRenderInfoEntity
     */
    public static WaybillListRenderInfoEntity toWaybillListRenderInfoEntity(WaybillListRenderInfoEntityVo vo, CommParamsVo commParamsVo) {
        WaybillListRenderInfoEntity entity = new WaybillListRenderInfoEntity();
        // 自增ID
