...
/**
 * org_config_driving_item_define 转换类
 */
public class OrgConfigDrivingItemDefineEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return OrgConfigDrivingItemDefineEntity
     */
    public static OrgConfigDrivingItemDefineEntity toOrgConfigDrivingItemDefineEntity(OrgConfigDrivingItemDefineEntityVo vo, CommParamsVo commParamsVo) {
        OrgConfigDrivingItemDefineEntity entity = new OrgConfigDrivingItemDefineEntity();
        // 自增ID
