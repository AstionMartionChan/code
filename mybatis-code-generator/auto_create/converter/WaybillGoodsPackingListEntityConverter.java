...
/**
 * waybill_goods_packing_list 转换类
 */
public class WaybillGoodsPackingListEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillGoodsPackingListEntity
     */
    public static WaybillGoodsPackingListEntity toWaybillGoodsPackingListEntity(WaybillGoodsPackingListEntityVo vo, CommParamsVo commParamsVo) {
        WaybillGoodsPackingListEntity entity = new WaybillGoodsPackingListEntity();
        // 自增ID
