...
/**
 * waybill_detail_render_info 转换类
 */
public class WaybillDetailRenderInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillDetailRenderInfoEntity
     */
    public static WaybillDetailRenderInfoEntity toWaybillDetailRenderInfoEntity(WaybillDetailRenderInfoEntityVo vo, CommParamsVo commParamsVo) {
        WaybillDetailRenderInfoEntity entity = new WaybillDetailRenderInfoEntity();
        // 自增ID
