 ...
 * lbs_device_bind 转换类
 */
public class LbsDeviceBindEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return LbsDeviceBindEntity
     */
    public static LbsDeviceBindEntity toLbsDeviceBindEntity(LbsDeviceBindEntityVo vo, CommParamsVo commParamsVo) {
        LbsDeviceBindEntity entity = new LbsDeviceBindEntity();
        // 自增Id
        ...
        entity.setAccessMode(vo.getAccessMode());
        // 设备状态
        entity.setEquipStatus(vo.getEquipStatus());
        // 设备名称
