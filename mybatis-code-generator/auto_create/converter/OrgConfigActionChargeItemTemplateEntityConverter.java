...
/**
 * org_config_action_charge_item_template 转换类
 */
public class OrgConfigActionChargeItemTemplateEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return OrgConfigActionChargeItemTemplateEntity
     */
    public static OrgConfigActionChargeItemTemplateEntity toOrgConfigActionChargeItemTemplateEntity(OrgConfigActionChargeItemTemplateEntityVo vo, CommParamsVo commParamsVo) {
        OrgConfigActionChargeItemTemplateEntity entity = new OrgConfigActionChargeItemTemplateEntity();
        // 自增ID
