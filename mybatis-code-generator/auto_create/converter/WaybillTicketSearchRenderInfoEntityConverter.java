...
/**
 * waybill_ticket_search_render_info 转换类
 */
public class WaybillTicketSearchRenderInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillTicketSearchRenderInfoEntity
     */
    public static WaybillTicketSearchRenderInfoEntity toWaybillTicketSearchRenderInfoEntity(WaybillTicketSearchRenderInfoEntityVo vo, CommParamsVo commParamsVo) {
        WaybillTicketSearchRenderInfoEntity entity = new WaybillTicketSearchRenderInfoEntity();
        // 自增ID
