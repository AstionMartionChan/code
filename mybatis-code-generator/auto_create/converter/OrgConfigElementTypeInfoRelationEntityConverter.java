...
/**
 * org_config_element_type_info_relation 转换类
 */
public class OrgConfigElementTypeInfoRelationEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return OrgConfigElementTypeInfoRelationEntity
     */
    public static OrgConfigElementTypeInfoRelationEntity toOrgConfigElementTypeInfoRelationEntity(OrgConfigElementTypeInfoRelationEntityVo vo, CommParamsVo commParamsVo) {
        OrgConfigElementTypeInfoRelationEntity entity = new OrgConfigElementTypeInfoRelationEntity();
        // 自增id
        entity.setId(vo.getId());
        // Element Type Code
        entity.setElementCode(vo.getElementCode());
        // Element Type信息Code
        entity.setElementInfoCode(vo.getElementInfoCode());
        // 描述
