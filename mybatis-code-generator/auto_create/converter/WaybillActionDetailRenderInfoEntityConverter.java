...
/**
 * waybill_action_detail_render_info 转换类
 */
public class WaybillActionDetailRenderInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillActionDetailRenderInfoEntity
     */
    public static WaybillActionDetailRenderInfoEntity toWaybillActionDetailRenderInfoEntity(WaybillActionDetailRenderInfoEntityVo vo, CommParamsVo commParamsVo) {
        WaybillActionDetailRenderInfoEntity entity = new WaybillActionDetailRenderInfoEntity();
        // 自增ID
