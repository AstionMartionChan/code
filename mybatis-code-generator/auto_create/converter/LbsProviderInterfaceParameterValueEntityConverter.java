...
/**
 * lbs_provider_interface_parameter_value 转换类
 */
public class LbsProviderInterfaceParameterValueEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return LbsProviderInterfaceParameterValueEntity
     */
    public static LbsProviderInterfaceParameterValueEntity toLbsProviderInterfaceParameterValueEntity(LbsProviderInterfaceParameterValueEntityVo vo, CommParamsVo commParamsVo) {
        LbsProviderInterfaceParameterValueEntity entity = new LbsProviderInterfaceParameterValueEntity();
        // 自增Id
        entity.setId(vo.getId());
        // 编码
        entity.setCode(vo.getCode());
        // 设备绑定信息编码
        entity.setDeviceBindCode(vo.getDeviceBindCode());
        // 参数Key
