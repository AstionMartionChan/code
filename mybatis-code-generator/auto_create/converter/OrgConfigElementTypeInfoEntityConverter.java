...
/**
 * org_config_element_type_info 转换类
 */
public class OrgConfigElementTypeInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return OrgConfigElementTypeInfoEntity
     */
    public static OrgConfigElementTypeInfoEntity toOrgConfigElementTypeInfoEntity(OrgConfigElementTypeInfoEntityVo vo, CommParamsVo commParamsVo) {
        OrgConfigElementTypeInfoEntity entity = new OrgConfigElementTypeInfoEntity();
        // 自增id
        ...
        // 表现形式
        entity.setControlType(vo.getControlType());
        // 数据源
