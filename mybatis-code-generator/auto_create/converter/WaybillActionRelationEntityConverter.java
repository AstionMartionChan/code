...
/**
 * waybill_action_relation 转换类
 */
public class WaybillActionRelationEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillActionRelationEntity
     */
    public static WaybillActionRelationEntity toWaybillActionRelationEntity(WaybillActionRelationEntityVo vo, CommParamsVo commParamsVo) {
        WaybillActionRelationEntity entity = new WaybillActionRelationEntity();
        // 自增ID
