 ...
 * lbs_alarm_log 转换类
 */
public class LbsAlarmLogEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return LbsAlarmLogEntity
     */
    public static LbsAlarmLogEntity toLbsAlarmLogEntity(LbsAlarmLogEntityVo vo, CommParamsVo commParamsVo) {
        LbsAlarmLogEntity entity = new LbsAlarmLogEntity();
        // 自增Id
        entity.setId(vo.getId());
        // 编码
        entity.setCode(vo.getCode());
        // 关联记录编码
        entity.setRelatedCode(vo.getRelatedCode());
        // 报警类型 1.进出围栏 2.停留
        entity.setAlarmType(vo.getAlarmType());
        // 是否已读 0.否 1.是
        entity.setReadFlag(vo.getReadFlag());
        // 描述
