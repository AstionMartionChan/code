...
/**
 * lbs_polygon_access_log 转换类
 */
public class LbsPolygonAccessLogEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return LbsPolygonAccessLogEntity
     */
    public static LbsPolygonAccessLogEntity toLbsPolygonAccessLogEntity(LbsPolygonAccessLogEntityVo vo, CommParamsVo commParamsVo) {
        LbsPolygonAccessLogEntity entity = new LbsPolygonAccessLogEntity();
        // 自增Id
        ...
        // 围栏编码
        entity.setPolygonCode(vo.getPolygonCode());
        // 围栏名称
        entity.setPolygonName(vo.getPolygonName());
        // 进出类型  1.进 2.出
        entity.setAccessType(vo.getAccessType());
        // 进出时间
        entity.setAccessTime(vo.getAccessTime());
        // 经度
