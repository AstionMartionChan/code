...
/**
 * waybill_driving_item_define 转换类
 */
public class WaybillDrivingItemDefineEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillDrivingItemDefineEntity
     */
    public static WaybillDrivingItemDefineEntity toWaybillDrivingItemDefineEntity(WaybillDrivingItemDefineEntityVo vo, CommParamsVo commParamsVo) {
        WaybillDrivingItemDefineEntity entity = new WaybillDrivingItemDefineEntity();
        // 自增ID
        ...
        // 记录项类型（1、数字，2、文本）
        entity.setDrivingItemType(vo.getDrivingItemType());
        // 描述
