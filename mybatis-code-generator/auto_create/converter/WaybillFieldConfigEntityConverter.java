...
/**
 * waybill_field_config 转换类
 */
public class WaybillFieldConfigEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillFieldConfigEntity
     */
    public static WaybillFieldConfigEntity toWaybillFieldConfigEntity(WaybillFieldConfigEntityVo vo, CommParamsVo commParamsVo) {
        WaybillFieldConfigEntity entity = new WaybillFieldConfigEntity();
        // 自增ID
