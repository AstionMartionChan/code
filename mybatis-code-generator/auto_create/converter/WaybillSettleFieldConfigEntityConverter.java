...
/**
 * waybill_settle_field_config 转换类
 */
public class WaybillSettleFieldConfigEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillSettleFieldConfigEntity
     */
    public static WaybillSettleFieldConfigEntity toWaybillSettleFieldConfigEntity(WaybillSettleFieldConfigEntityVo vo, CommParamsVo commParamsVo) {
        WaybillSettleFieldConfigEntity entity = new WaybillSettleFieldConfigEntity();
        // 自增ID
