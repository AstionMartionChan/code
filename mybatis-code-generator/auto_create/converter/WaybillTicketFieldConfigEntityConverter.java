...
/**
 * waybill_ticket_field_config 转换类
 */
public class WaybillTicketFieldConfigEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillTicketFieldConfigEntity
     */
    public static WaybillTicketFieldConfigEntity toWaybillTicketFieldConfigEntity(WaybillTicketFieldConfigEntityVo vo, CommParamsVo commParamsVo) {
        WaybillTicketFieldConfigEntity entity = new WaybillTicketFieldConfigEntity();
        // 自增ID
