...
/**
 * org_config_action_template 转换类
 */
public class OrgConfigActionTemplateEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return OrgConfigActionTemplateEntity
     */
    public static OrgConfigActionTemplateEntity toOrgConfigActionTemplateEntity(OrgConfigActionTemplateEntityVo vo, CommParamsVo commParamsVo) {
        OrgConfigActionTemplateEntity entity = new OrgConfigActionTemplateEntity();
        // 自增ID
        ...
        // 模板排序号
        entity.setTemplateSeqNo(vo.getTemplateSeqNo());
        // 描述
