...
/**
 * waybill_settle_list_render_info 转换类
 */
public class WaybillSettleListRenderInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillSettleListRenderInfoEntity
     */
    public static WaybillSettleListRenderInfoEntity toWaybillSettleListRenderInfoEntity(WaybillSettleListRenderInfoEntityVo vo, CommParamsVo commParamsVo) {
        WaybillSettleListRenderInfoEntity entity = new WaybillSettleListRenderInfoEntity();
        // 自增ID
