...
/**
 * org_config_action_condition_define 转换类
 */
public class OrgConfigActionConditionDefineEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return OrgConfigActionConditionDefineEntity
     */
    public static OrgConfigActionConditionDefineEntity toOrgConfigActionConditionDefineEntity(OrgConfigActionConditionDefineEntityVo vo, CommParamsVo commParamsVo) {
        OrgConfigActionConditionDefineEntity entity = new OrgConfigActionConditionDefineEntity();
        // 自增ID
