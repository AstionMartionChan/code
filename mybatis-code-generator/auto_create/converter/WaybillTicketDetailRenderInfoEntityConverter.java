...
/**
 * waybill_ticket_detail_render_info 转换类
 */
public class WaybillTicketDetailRenderInfoEntityConverter {

    /**
     * 转换Entity
     * @param vo 基本信息
     * @param commParamsVo 公共参数
     * @return WaybillTicketDetailRenderInfoEntity
     */
    public static WaybillTicketDetailRenderInfoEntity toWaybillTicketDetailRenderInfoEntity(WaybillTicketDetailRenderInfoEntityVo vo, CommParamsVo commParamsVo) {
        WaybillTicketDetailRenderInfoEntity entity = new WaybillTicketDetailRenderInfoEntity();
        // 自增ID
