...
@ApiImplicitParam(name = "drivingToTruckCode", value = "记录归属车辆编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "drivingItemCode", value = "记录项编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "drivingItemName", value = "记录项名称", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "drivingItemNumber", value = "记录数量", required = true, dataType = "Double", paramType = "form"),
@ApiImplicitParam(name = "drivingItemNumberUnitCode", value = "记录数量单位编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "drivingItemDesc", value = "记录内容", required = true, dataType = "String", paramType = "form"),
