...
@ApiImplicitParam(name = "code", value = "厂商编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "providerName", value = "厂商名", required = true, dataType = "String", paramType = "form"),
