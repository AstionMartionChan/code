...
@ApiImplicitParam(name = "supportRonglian", value = "是否支持融链平台接入", required = true, dataType = "Boolean", paramType = "form"),
@ApiImplicitParam(name = "supportThird", value = "是否支持第三方接入", required = true, dataType = "Boolean", paramType = "form"),
@ApiImplicitParam(name = "bindUrl", value = "绑定url 例如 天易  {domain}/bind?licenseNo={licenseNo}&accessMode={accessMode}&sn={sn}&sim={sim} licenseNo 和 accessMode 为固定字段 sn 和 sim 为 车载厂商配置附加参数表 配置数据", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "unbindUrl", value = "解绑url 例如 天易  {domain}/unbind?sn={sn}&sim={sim} sn 和 sim 为 车载厂商配置附加参数表 配置数据", required = true, dataType = "String", paramType = "form"),
