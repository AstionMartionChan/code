...
@ApiImplicitParam(name = "resourceCode", value = "静态资源唯一编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "storePath", value = "图片访问绝对路径", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "height", value = "图片高度", required = true, dataType = "Integer", paramType = "form"),
@ApiImplicitParam(name = "width", value = "图片宽度", required = true, dataType = "Integer", paramType = "form"),
@ApiImplicitParam(name = "isOriginalSize", value = "是否原始尺寸", required = true, dataType = "Boolean", paramType = "form"),
@ApiImplicitParam(name = "description", value = "描述", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "remark", value = "备注（平台运营人员备注）", required = true, dataType = "String", paramType = "form"),
