...
@ApiImplicitParam(name = "deviceBindCode", value = "设备绑定信息编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "parameterKey", value = "参数Key", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "parameterValue", value = "参数Value", required = true, dataType = "String", paramType = "form"),
