...
@ApiImplicitParam(name = "elementInfoCode", value = "Element Type信息Code", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "type", value = "表示该属性是否从平台拷贝过来 1.平台 2. 企业自定义", required = true, dataType = "Integer", paramType = "form"),
@ApiImplicitParam(name = "controlType", value = "表现形式", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "datasource", value = "数据源", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "event", value = "事件", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "modelId", value = "模版id", required = true, dataType = "String", paramType = "form"),
