...
@ApiImplicitParam(name = "actionRecordCode", value = "业务动作执行记录编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "chargeToTruckCode", value = "费用归属车辆编码", required = true, dataType = "String", paramType = "form"),
...
@ApiImplicitParam(name = "chargeItemNumber", value = "记账数量", required = true, dataType = "Double", paramType = "form"),
...
@ApiImplicitParam(name = "chargeItemPrice", value = "记账单价", required = true, dataType = "Double", paramType = "form"),
...
@ApiImplicitParam(name = "chargeAmounts", value = "记账金额", required = true, dataType = "Double", paramType = "form"),
@ApiImplicitParam(name = "chargeAmountsUnitCode", value = "记账金额单位编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "chargeAmountsUnitName", value = "记账金额计量单位名称", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "customData", value = "自定义属性", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "attachmentList", value = "附件列表，多个用分号隔开", required = true, dataType = "String", paramType = "form"),
