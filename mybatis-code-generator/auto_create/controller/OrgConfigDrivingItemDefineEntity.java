...
@ApiImplicitParam(name = "drivingItemNumberUnitCode", value = "记录项数量单位编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "drivingItemDesc", value = "记录项描述", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "drivingItemType", value = "记录项类型（1、数字，2、文本）", required = true, dataType = "Integer", paramType = "form"),
