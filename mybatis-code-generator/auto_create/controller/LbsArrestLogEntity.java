...
@ApiImplicitParam(name = "startTime", value = "停留开始时间", required = true, dataType = "Date", paramType = "form"),
@ApiImplicitParam(name = "endTime", value = "停留截止时间", required = true, dataType = "Date", paramType = "form"),
