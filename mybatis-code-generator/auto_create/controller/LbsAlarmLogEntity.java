...
@ApiImplicitParam(name = "relatedCode", value = "关联记录编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "alarmType", value = "报警类型 1.进出围栏 2.停留", required = true, dataType = "Integer", paramType = "form"),
@ApiImplicitParam(name = "readFlag", value = "是否已读 0.否 1.是", required = true, dataType = "Boolean", paramType = "form"),
