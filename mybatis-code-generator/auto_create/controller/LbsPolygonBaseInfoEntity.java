...
@ApiImplicitParam(name = "polygonCode", value = "电子围栏编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "polygonName", value = "电子围栏名称", required = true, dataType = "String", paramType = "form"),
