...
@ApiImplicitParam(name = "code", value = "设备绑定信息编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "deviceCode", value = "设备编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "providerCode", value = "厂商编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "type", value = "类型", required = true, dataType = "Integer", paramType = "form"),
@ApiImplicitParam(name = "accessMode", value = "接入方式(1 融链平台接入 2 第三方平台接入)", required = true, dataType = "Integer", paramType = "form"),
@ApiImplicitParam(name = "equipStatus", value = "设备状态", required = true, dataType = "Integer", paramType = "form"),
@ApiImplicitParam(name = "deviceName", value = "设备名称", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "deviceNo", value = "设备号", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "simCardNo", value = "流量卡号", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "openingTime", value = "开通时间", required = true, dataType = "Date", paramType = "form"),
@ApiImplicitParam(name = "expiryDate", value = "到期时间", required = true, dataType = "Date", paramType = "form"),
@ApiImplicitParam(name = "orgCode", value = "公司编码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "orgName", value = "公司名字", required = true, dataType = "String", paramType = "form"),
