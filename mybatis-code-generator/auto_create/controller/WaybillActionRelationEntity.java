...
@ApiImplicitParam(name = "templateName", value = "业务动作模板名称", required = true, dataType = "String", paramType = "form"),
...
@ApiImplicitParam(name = "actionName", value = "业务动作名称", required = true, dataType = "String", paramType = "form"),
...
@ApiImplicitParam(name = "actionPermissionCode", value = "业务动作执行权限代码", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "actionRepeat", value = "是否可重复执行", required = true, dataType = "Integer", paramType = "form"),
