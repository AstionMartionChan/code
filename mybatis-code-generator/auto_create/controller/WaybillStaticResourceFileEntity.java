...
@ApiImplicitParam(name = "resourceCode", value = "资源唯一编码（使用UUID）", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "storePath", value = "文件存储路径", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "fileName", value = "", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "originalName", value = "", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "fileType", value = "jpg/pdf/excel/ppt/...", required = true, dataType = "String", paramType = "form"),
@ApiImplicitParam(name = "fileSize", value = "文件大小(kb)", required = true, dataType = "Integer", paramType = "form"),
@ApiImplicitParam(name = "height", value = "高度", required = true, dataType = "Integer", paramType = "form"),
@ApiImplicitParam(name = "width", value = "宽度", required = true, dataType = "Integer", paramType = "form"),
@ApiImplicitParam(name = "lastModifyDate", value = "文件最后修改日期", required = true, dataType = "Date", paramType = "form"),
@ApiImplicitParam(name = "isPermission", value = "0 不需要权限 1 需要权限", required = true, dataType = "Boolean", paramType = "form"),
