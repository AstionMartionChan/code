...
/**
 * org_config_element_type_info_relation
 */
@ApiModel("org_config_element_type_info_relation")
public class OrgConfigElementTypeInfoRelationResult {
    ...
    // Element Type Code
    @ApiModelProperty("Element Type Code")
    ...
    /**
     * set Element Type Code
     * @param elementCode Element Type Code
     */
     ...
     * @return String Element Type Code
     */
