...
/**
 * lbs_provider_interface_parameter_define
 */
@ApiModel("lbs_provider_interface_parameter_define")
public class LbsProviderInterfaceParameterDefineResult {
    ...
    // 附加参数名称
    @ApiModelProperty("附加参数名称")
    private String parameterName;

    // 附加参数Key
    @ApiModelProperty("附加参数Key")
