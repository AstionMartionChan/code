...
/**
 * waybill_action_field_config
 */
@ApiModel("waybill_action_field_config")
public class WaybillActionFieldConfigResult {
    ...
    // 字段配置code唯一性
    @ApiModelProperty("字段配置code唯一性")
    private String fieldConfigCode;

    // 字段定义名称
    @ApiModelProperty("字段定义名称")
    ...
    // 额外属性，json格式存储
    @ApiModelProperty("额外属性，json格式存储")
    private String extraParams;

    // 检索元素类型
    @ApiModelProperty("检索元素类型")
    private String searchElementCode;

    // 检索额外属性，json格式存储
    @ApiModelProperty("检索额外属性，json格式存储")
