 ...
 * lbs_alarm_log
 */
@ApiModel("lbs_alarm_log")
public class LbsAlarmLogResult {
    ...
    // 关联记录编码
    @ApiModelProperty("关联记录编码")
    private String relatedCode;

    // 报警类型 1.进出围栏 2.停留
    @ApiModelProperty("报警类型 1.进出围栏 2.停留")
    ...
    /**
     * set 报警类型 1.进出围栏 2.停留
     * @param alarmType 报警类型 1.进出围栏 2.停留
     */
    ...
    /**
     * get 报警类型 1.进出围栏 2.停留
     * @return Integer 报警类型 1.进出围栏 2.停留
     */
