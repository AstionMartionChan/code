...
/**
 * org_config_measure_unit_define
 */
@ApiModel("org_config_measure_unit_define")
public class OrgConfigMeasureUnitDefineResult {
    ...
    @ApiModelProperty("编码类型（车长宽高：truck.size，车载重：truck.carry，车容积：truck.cubage，司机运价：driver.price，标准时长：route.duration，货物单价：goods.price，承运价：carrier.price）")
    private String codeType;

    // 单位类型：ton、truck、cube 等
    @ApiModelProperty("单位类型：ton、truck、cube 等")
