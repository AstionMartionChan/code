...
/**
 * org_config_action_condition_define
 */
@ApiModel("org_config_action_condition_define")
public class OrgConfigActionConditionDefineResult {
    ...
    // 条件类型：1.前置条件2.后置条件
    @ApiModelProperty("条件类型：1.前置条件2.后置条件")
    private Integer conditionType;

    // 比较字段
    @ApiModelProperty("比较字段")
    private String compareField;

    // 预期的值
    @ApiModelProperty("预期的值")
    private String compareValue;

    // 预期比较结果：0.相等1.大于-1.小于
    @ApiModelProperty("预期比较结果：0.相等1.大于-1.小于")
    private Integer compareResult;

    // 与其他条件的关系：1并且、2或者
    @ApiModelProperty("与其他条件的关系：1并且、2或者")
