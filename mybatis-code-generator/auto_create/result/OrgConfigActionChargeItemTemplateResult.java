...
/**
 * org_config_action_charge_item_template
 */
@ApiModel("org_config_action_charge_item_template")
public class OrgConfigActionChargeItemTemplateResult {
    ...
    @ApiModelProperty("可见性配置：bit0Web端是否可见，bit1司机端是否可见")
