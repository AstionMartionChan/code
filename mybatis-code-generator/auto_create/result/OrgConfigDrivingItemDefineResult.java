...
/**
 * org_config_driving_item_define
 */
@ApiModel("org_config_driving_item_define")
public class OrgConfigDrivingItemDefineResult {
    ...
    // 记录项数量单位编码
    @ApiModelProperty("记录项数量单位编码")
    private String drivingItemNumberUnitCode;

    // 记录项描述
    @ApiModelProperty("记录项描述")
    private String drivingItemDesc;

    // 记录项类型（1、数字，2、文本）
    @ApiModelProperty("记录项类型（1、数字，2、文本）")
    private Integer drivingItemType;
    ...
    /**
     * set 记录项数量单位编码
     * @param drivingItemNumberUnitCode 记录项数量单位编码
     */
    ...
    /**
     * set 记录项类型（1、数字，2、文本）
     * @param drivingItemType 记录项类型（1、数字，2、文本）
     */
    public void setDrivingItemType(Integer drivingItemType) {
        this.drivingItemType = drivingItemType;
    }

    /**
     * get 记录项类型（1、数字，2、文本）
     * @return Integer 记录项类型（1、数字，2、文本）
     */
    public Integer getDrivingItemType() {
        return drivingItemType;
    }
