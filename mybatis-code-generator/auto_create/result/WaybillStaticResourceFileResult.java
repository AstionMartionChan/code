...
/**
 * waybill_static_resource_file
 */
@ApiModel("waybill_static_resource_file")
public class WaybillStaticResourceFileResult {
    ...
    // 资源唯一编码（使用UUID）
    @ApiModelProperty("资源唯一编码（使用UUID）")
    ...
    // jpg/pdf/excel/ppt/...
    @ApiModelProperty("jpg/pdf/excel/ppt/...")
    ...
    // 0 不需要权限 1 需要权限
    @ApiModelProperty("0 不需要权限 1 需要权限")
    ...
    /**
     * set 资源唯一编码（使用UUID）
     * @param resourceCode 资源唯一编码（使用UUID）
     */
    ...
    /**
     * set jpg/pdf/excel/ppt/...
     * @param fileType jpg/pdf/excel/ppt/...
     */
    ...
    /**
     * get jpg/pdf/excel/ppt/...
     * @return String jpg/pdf/excel/ppt/...
     */
    ...
    /**
     * set 0 不需要权限 1 需要权限
     * @param isPermission 0 不需要权限 1 需要权限
     */
