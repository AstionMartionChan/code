...
# **********************程序说明*********************************#
# *模块：odl
# *功能：mysql audit_system同步
# *作者：Leo
# *时间：2018-07-04
# *备注：mysql audit_system同步
# ***************************************************************#
...
from project_constant import DB_PARAMS_AUDIT_SYSTEM, DB_PARAMS_AUDIT_SYSTEM_HOSTS, AUDIT_SYSTEM_TAB_SYNC_INFO
...
def main():
    ...
    args['db_params'] = DB_PARAMS_AUDIT_SYSTEM
    args['mysqlhosts'] = DB_PARAMS_AUDIT_SYSTEM_HOSTS
    args['mysqltabs'] = AUDIT_SYSTEM_TAB_SYNC_INFO
