...
,his_income   
from {sourcetab}
where ds='{ds}' and itemid is not null; 
...
sync1=r'''/usr/bin/sqoop-export  --export-dir /user/hive/warehouse/wutiao_db/report_wutiao_itemid_uid_output/ds='{ds}'/type=itemid --connect jdbc:mysql://{host}:{port}/wutiao --username "{user}" --password '{password}' --table "report_wutiao_itemid_output" --input-fields-terminated-by "|" --input-null-string "\\\N" --input-null-non-string "\\\N" '''

delete2=r'''echo "use wutiao; delete from report_wutiao_uid_output where fds ='{ds}'; " |mysql -h {host} -u {user} -p{password} '''
sync2=r'''/usr/bin/sqoop-export  --export-dir /user/hive/warehouse/wutiao_db/report_wutiao_itemid_uid_output/ds='{ds}'/type=uid --connect jdbc:mysql://{host}:{port}/wutiao --username "{user}" --password '{password}' --table "report_wutiao_uid_output" --input-fields-terminated-by "|" --input-null-string "\\\N" --input-null-non-string "\\\N" '''
