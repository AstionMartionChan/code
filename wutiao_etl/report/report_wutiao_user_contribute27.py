...
sync=r'''/usr/bin/sqoop-export  --export-dir /user/hive/warehouse/wutiao_db/report_wutiao_user_contribute/ds='{ds}' --connect jdbc:mysql://{host}:{port}/wutiao --username "{user}" --password '{password}' --table "report_wutiao_user_contribute" --input-fields-terminated-by "|" --input-null-string "\\\N" --input-null-non-string "\\\N" '''
