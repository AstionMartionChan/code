...
,hour
from {sourcetab}
where ds='{last_hour_ds}' and hour='{last_hour}' and event in('comment','like','read')
...
hourfile_check = '''hadoop fs -test -e /user/hive/warehouse/wutiao_db/adl_wutiao_itemid_realtime/ds='{last_hour_ds}'/hour='{last_hour}' '''
dayfile_check = '''hadoop fs -test -e /user/hive/warehouse/wutiao_db/adl_wutiao_itemid_realtime/ds='{ds}'/hour=99 '''
