...
/**
 * Created by Leo_Chan on 2017/8/24.
 */
public class WaybillReportVo {
    ...
    */
    ...
    // 驾驶员姓名
    // 选填 集合字符串 用,分隔
    private String driverNameOfPersonListString;

    // 驾驶员从业资格证号
    // 选填 集合字符串 用,分隔
    private String driverQualificationCertificateNumberListString;

    // 驾驶员电话号码
    // 选填 集合字符串 用,分隔
    private String driverTelephoneNumberListString;

    // 货物名称
    // 必填 集合字符串 用,分隔
    private String goodsDescriptionOfGoodsListString;

    // 货物类型分类代码
    // 必填 集合字符串 用,分隔
    private String goodsCargoTypeClassificationCodeListString;

    // 货物项毛重
    // 必填 集合字符串 用,分隔
    private String goodsGoodsItemGrossWeightListString;

    // 货物体积
    // 选填 集合字符串 用,分隔
    private String goodsCubeListString;

    // 货物总件数
    // 选填 集合字符串 用,分隔
    private String goodsTotalNumberOfPackagesListString;
    ...
    public String getDriverNameOfPersonListString() {
        return driverNameOfPersonListString;
    }

    public void setDriverNameOfPersonListString(String driverNameOfPersonListString) {
        this.driverNameOfPersonListString = driverNameOfPersonListString;
    }

    public String getDriverQualificationCertificateNumberListString() {
        return driverQualificationCertificateNumberListString;
    }

    public void setDriverQualificationCertificateNumberListString(String driverQualificationCertificateNumberListString) {
        this.driverQualificationCertificateNumberListString = driverQualificationCertificateNumberListString;
    }

    public String getDriverTelephoneNumberListString() {
        return driverTelephoneNumberListString;
    }

    public void setDriverTelephoneNumberListString(String driverTelephoneNumberListString) {
        this.driverTelephoneNumberListString = driverTelephoneNumberListString;
    }

    public String getGoodsDescriptionOfGoodsListString() {
        return goodsDescriptionOfGoodsListString;
    }

    public void setGoodsDescriptionOfGoodsListString(String goodsDescriptionOfGoodsListString) {
        this.goodsDescriptionOfGoodsListString = goodsDescriptionOfGoodsListString;
    }

    public String getGoodsCargoTypeClassificationCodeListString() {
        return goodsCargoTypeClassificationCodeListString;
    }

    public void setGoodsCargoTypeClassificationCodeListString(String goodsCargoTypeClassificationCodeListString) {
        this.goodsCargoTypeClassificationCodeListString = goodsCargoTypeClassificationCodeListString;
    }

    public String getGoodsGoodsItemGrossWeightListString() {
        return goodsGoodsItemGrossWeightListString;
    }

    public void setGoodsGoodsItemGrossWeightListString(String goodsGoodsItemGrossWeightListString) {
        this.goodsGoodsItemGrossWeightListString = goodsGoodsItemGrossWeightListString;
    }

    public String getGoodsCubeListString() {
        return goodsCubeListString;
    }

    public void setGoodsCubeListString(String goodsCubeListString) {
        this.goodsCubeListString = goodsCubeListString;
    }

    public String getGoodsTotalNumberOfPackagesListString() {
        return goodsTotalNumberOfPackagesListString;
    }

    public void setGoodsTotalNumberOfPackagesListString(String goodsTotalNumberOfPackagesListString) {
        this.goodsTotalNumberOfPackagesListString = goodsTotalNumberOfPackagesListString;
    }
